...
<body>
        ...
        <div class="container">
            ...
            <div class="header__info" id="header__info">
                <div class="header__cont">
                    ...
                    <h1 class="header__title">ДИЗАЙН ИНТЕРЬЕРА</h1>
    ...
    <main>
        <div class="complex">
            <div class="container">
                <h1 class="complex__title">Комплекс работ включает в себя</h1>
                <div class="complex__items">
                    <div class="complex__item">
                        <div class="complex__img"></div>
                        <h2 class="complex__item-title">Чертежи</h2>
                        <p class="complex__item-text">Разрабатываем рабочую документацию, план и чертежи для строителей</p>
                    </div>
                    <div class="complex__item">
                        <div class="complex__img"></div>
                        <h2 class="complex__item-title">Визауализация</h2>
                        <p class="complex__item-text">Создаём 3D-визуализацию вашего будущего проекта</p>
                    </div>
                    <div class="complex__item">
                        <div class="complex__img"></div>
                        <h2 class="complex__item-title">Финансы</h2>
                        <p class="complex__item-text">Полностью расчитываем стоимость на материалы</p>
                    </div>
                    <div class="complex__item">
                        <div class="complex__img"></div>
                        <h2 class="complex__item-title">Согласование</h2>
                        <p class="complex__item-text">Согласовываем с вами дизайн-проект</p>
                    </div>
                    <div class="complex__item">
                        <div class="complex__img"></div>
                        <h2 class="complex__item-title">Работа</h2>
                        <p class="complex__item-text">Выполняем все необходимые работы по воплащению идеи и чертежа</p>
                    </div>
                    <div class="complex__item">
                        <div class="complex__img"></div>
                        <h2 class="complex__item-title">Контроль</h2>
                        <p class="complex__item-text">Следим за правильной реализацией проекта</p>
                    </div>
                </div>
            </div>
        </div>
